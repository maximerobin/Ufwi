...
class TestRoute1(templateRoutedNetworks):
    """
    ...
    network_test = {
      ...
      "should_have_interfaces":'auto eth1\n' \
         ...
         '    post-up ip route add 192.168.60.0/24 via 192.168.72.60 dev eth1',
      "should_have_ip_route":'192.168.60.0/24 via 192.168.72.60 dev eth1'
    }
