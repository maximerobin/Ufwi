# Backport of Lib/xmlrpclib.py from Python trunk (rev 74543)
# Changes for the integration in Rpcd:
#  - replace "import httplib" by "from ufwi_rpcd.common import httplib"
#    to use backported version of httplib
#  - replace "e.errno" by "e.args[0]" in Transport.request()
#  - Transport.request() catchs also errno.EPIPE: fix the following bug
...
import socket
import errno
from ufwi_rpcd.python import httplib
try:
    import gzip
except ImportError:
    ...
    def request(self, host, handler, request_body, verbose=0):
        ...
        for i in (0, 1):
            try:
                ...
                # see http://bugs.python.org/issue9032 for EPIPE
                if i or e.args[0] not in (errno.ECONNRESET, errno.ECONNABORTED, errno.EPIPE):
                    raise
