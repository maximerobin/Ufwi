...
{
  "$end", "error", "$undefined", "TOK_EQUAL", "TOK_WORD", "TOK_SECTION",
  "TOK_STRING", "$accept", "config", "section", "key_value", 0
};
#endif
...
/* Line 1009 of yacc.c  */
#line 55 "config-parser.yacc.y"
	{ free ((yyvaluep->string)); };

/* Line 1009 of yacc.c  */
#line 1099 "config-parser.yacc.c"
	break;
      case 5: /* "TOK_SECTION" */
...
/* Line 1009 of yacc.c  */
#line 1108 "config-parser.yacc.c"
	break;
...
#line 90 "config-parser.yacc.y"
    {
				ufwibase_config_table_set_with_section(config_arg->parsed_config, config_arg->current_section, (yyvsp[(1) - (3)].string), (yyvsp[(3) - (3)].string));
...
/* Line 1464 of yacc.c  */
#line 1472 "config-parser.yacc.c"
      default: break;
    }
