...
#ifndef UFWISSL_SSL_COMMON_H
#define UFWISSL_SSL_COMMON_H
...
struct ufwissl_ssl_dname_s {
	int subject;		/* non-zero if this is the subject DN object */
	gnutls_x509_crt cert;
};

struct ufwissl_ssl_certificate_s {
	ufwissl_ssl_dname subj_dn, issuer_dn;
	gnutls_x509_crt subject;
	ufwissl_ssl_certificate *issuer;
	char *identity;
};

struct ufwissl_ssl_client_cert_s {
	gnutls_pkcs12 p12;
