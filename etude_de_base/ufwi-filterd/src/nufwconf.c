...
{
	return ufwibase_config_table_get(nufw_config_table_list, key);
}

char *nufw_config_table_get_alwaysstring(char *key)
{
	return ufwibase_config_table_get_alwaysstring(nufw_config_table_list, key);
}

char *nufw_config_table_get_or_default(char *key, char *replace)
{
	return ufwibase_config_table_get_or_default(nufw_config_table_list, key, replace);
}

int nufw_config_table_get_or_default_int(char *key, int defint)
{
	return ufwibase_config_table_get_or_default_int(nufw_config_table_list, key, defint);
}

void nufw_config_table_destroy(void)
{
	return ufwibase_config_table_destroy(nufw_config_table_list);
...
{
	return ufwibase_config_table_print(nufw_config_table_list,userdata,func);
}
