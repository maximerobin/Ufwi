...
Tout d'abord j'ai définie les règles Iptables comme suit de façon à déclencher une 
...
Concernant la configuration de nuauth j'ai gardé la configuration de base fourni avec l'image ISO.
En premier lieu, j'ai démarré le service nuauth dans un terminal:
